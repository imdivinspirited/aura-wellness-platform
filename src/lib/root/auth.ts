...
const SESSION_DURATION = 24 * 60 * 60 * 1000; // 24 hours (extended for better UX)
...
/**
 * Get current session (from localStorage for persistence)
 */
...
export function clearSession(): void {
  if (typeof window !== 'undefined') {
    ...
    // Also clear from sessionStorage if it exists (migration cleanup)
