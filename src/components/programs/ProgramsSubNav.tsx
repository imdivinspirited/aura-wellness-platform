...
const navItems: NavItem[] = [
  { id: 'beginning', label: 'Beginning', icon: Sparkles, href: '/programs?category=beginning' },
  { id: 'advanced', label: 'Advanced', icon: Zap, href: '/programs?category=advanced' },
  { id: 'children', label: 'Children', icon: Baby, href: '/programs?category=children' },
  { id: 'teens', label: 'Teens', icon: GraduationCap, href: '/programs?category=teens' },
  { id: 'more', label: 'More Programs', icon: LayoutGrid, href: '/programs?category=more' },
  { id: 'retreats', label: 'Retreats', icon: RotateCcw, href: '/programs?category=retreats' },
];
...
export const ProgramsSubNav = ({ activeItem, onItemClick }: ProgramsSubNavProps) => {
  ...
  const getActiveFromPath = () => {
    ...
    // Check query param first (unified approach)
