...
const navItems: NavItem[] = [
  { id: 'beginning', icon: Sparkles, href: '/programs?category=beginning' },
  { id: 'advanced', icon: Zap, href: '/programs?category=advanced' },
  { id: 'children', icon: Baby, href: '/programs?category=children' },
  { id: 'teens', icon: GraduationCap, href: '/programs?category=teens' },
  { id: 'more', icon: LayoutGrid, href: '/programs?category=more' },
  { id: 'retreats', icon: RotateCcw, href: '/programs?category=retreats' },
];
...
export const ProgramsSubNav = ({ activeItem, onItemClick }: ProgramsSubNavProps) => {
  ...
  return (
    <nav
      role="navigation"
      aria-label={t('programs.subNav.aria' as any)}
      ...
      <div className="container">
        ...
        >
          {navItems.map((item) => {
            ...
            const labelKey = `programs.subNav.${item.id}` as const;
