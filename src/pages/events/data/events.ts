...
export const allEvents: Event[] = [
  ...
  },
  {
    ...
    media: {
      banner: '/images/events/gurudev_birthday_celebration.jpg',
      thumbnail: '/images/events/gurudev_birthday_celebration.jpg',
      gallery: ['/images/events/gurudev_birthday_celebration.jpg'],
    },
    cta: {
      label: 'Participate',
      link: '/events/gurudev-birthday-2026',
    },
    liveStreamUrl: 'https://www.youtube.com/watch?v=example1',
    timeline: [
      { date: '2026-05-13', time: '06:30', timezone: 'Asia/Kolkata', title: 'Morning Meditation', description: 'Special birthday meditation' },
      { date: '2026-05-13', time: '18:30', timezone: 'Asia/Kolkata', title: 'Evening Satsang', description: 'Community celebration & service' },
    ],
    donations: { enabled: true },
    createdAt: '2025-01-15T10:00:00Z',
    updatedAt: '2025-01-15T10:00:00Z',
  ...
  // ==================== ONGOING EVENTS ====================
  {
    ...
    media: {
      banner: '/images/events/live_webcast_meditation.jpg',
      thumbnail: '/images/events/live_webcast_meditation.jpg',
    },
    cta: {
      label: 'Watch Live',
