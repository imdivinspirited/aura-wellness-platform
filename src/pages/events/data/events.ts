...
import {
  ...
  GURUDEV_BIRTHDAY_HERO_IMAGE_URL,
  GURUDEV_BIRTHDAY_IMAGE_URL,
...
export const allEvents: Event[] = [
  // ==================== UPCOMING EVENTS ====================
  {
    ...
    media: {
      banner: '/images/events/shivratri_celebration_night.jpg',
      thumbnail: '/images/events/shivratri_celebration_night.jpg',
      gallery: ['/images/events/shivratri_celebration_night.jpg'],
      videos: [],
    },
    cta: {
      label: 'Join the Celebration',
      link: '/events/maha-shivratri-2026',
      external: false,
    },
    isLive: false,
    liveStreamUrl: 'https://www.youtube.com/watch?v=example3',
    timeline: [
      { date: '2026-02-26', time: '18:00', timezone: 'Asia/Kolkata', title: 'Opening Ceremony', description: 'Welcome & invocation' },
      { date: '2026-02-26', time: '20:00', timezone: 'Asia/Kolkata', title: 'Guided Meditation', description: 'Deep meditation session' },
      { date: '2026-02-27', time: '00:00', timezone: 'Asia/Kolkata', title: 'Midnight Chanting', description: 'Chants & silence' },
      { date: '2026-02-27', time: '05:30', timezone: 'Asia/Kolkata', title: 'Sunrise Closing', description: 'Closing prayers' },
    ],
  ...
  },
  {
    ...
    description:
      'Each year, millions of hearts turn toward Bangalore and toward home centres worldwide to honour Gurudev Sri Sri Ravi Shankar — teacher, humanitarian, and voice of peace. The day weaves together silent sitting, satsang, seva, and celebration in a spirit of gratitude.\n\n' +
      'At The Art of Living International Center, programmes unfold through the day with space for both in-person gathering and thoughtful participation from afar. Wherever you are, you are welcome to align with the schedule, join official broadcasts when offered, and carry the stillness of the occasion into your community.\n\n' +
      'Use the tools on this page to save the date, share the gathering, and connect with the live channel — so the focus stays on presence, service, and collective prayer.',
    shortDescription:
      "Gurudev's 70th birthday and 45 years of The Art of Living — a global day of meditation, satsang, and seva, anchored at the International Center, Bangalore, and open to the world.",
    category: 'upcoming',
    status: 'upcoming',
    tags: ['celebration', 'birthday', 'service', 'meditation'],
    /** Focal celebration day (hero, timeline, countdowns). */
    startDate: '2026-05-13T06:00:00+05:30',
    endDate: '2026-05-13T23:59:59+05:30',
    /** Month-long participation arc: stays in Ongoing through May; Archive after May + grace. */
    ongoingFrom: '2026-05-01T00:00:00+05:30',
    ongoingUntil: '2026-05-31T23:59:59+05:30',
    pastGraceHours: 24,
    timezone: 'Asia/Kolkata',
    isAllDay: true,
    location: {
    ...
    highlights: [
      'Anchored programme at The Art of Living International Center, Bangalore',
      'Guided meditations and satsangs aligned with the global schedule',
      'Official webcast and channel updates for remote participation',
      'Seva, celebration, and silent sitting with sangha worldwide',
    ],
    stats: {
      /** ~3 lakh people expected (in-person + coordinated participation) */
      attendees: 300_000,
      countries: 180,
    },
    media: {
      /** Detail page + hero: International Center / gathering atmosphere */
      banner: GURUDEV_BIRTHDAY_HERO_IMAGE_URL,
      /** Cards + horizon + home featured tile: Gurudev portrait (distinct from banner) */
      thumbnail: GURUDEV_BIRTHDAY_CARD_IMAGE_URL,
      gallery: [
        GURUDEV_BIRTHDAY_HERO_IMAGE_URL,
        GURUDEV_BIRTHDAY_CARD_IMAGE_URL,
        GURUDEV_BIRTHDAY_IMAGE_URL,
    ...
    cta: {
      label: 'Participate',
      /** Opens participation sheet on the event page (`EventDetailPage` reads `?participate=1`). */
      link: '/events/gurudev-birthday-2026?participate=1',
    },
    timeline: [
      {
        date: '2026-05-13',
        time: '06:30',
        timezone: 'Asia/Kolkata',
        title: 'Morning meditation & opening',
        description: 'Collective sitting and orientation for the day — in person at the Center and with sangha online.',
      },
      {
        date: '2026-05-13',
        time: '12:00',
        timezone: 'Asia/Kolkata',
        title: 'Midday satsang window',
        description: 'Short programme segment; timings may shift — follow official channel announcements.',
      },
      {
        date: '2026-05-13',
        time: '18:30',
        timezone: 'Asia/Kolkata',
        title: 'Evening satsang & celebration',
        description: 'Community celebration, offerings, and closing reflections — broadcast where available.',
      },
    ],
    donations: { enabled: true },
    createdAt: '2025-01-15T10:00:00Z',
  ...
  },
  {
    ...
    /** One-hour global sit; tighter hand-off to Archive than default 24h if desired. */
    pastGraceHours: 24,
    timezone: 'UTC',
    isAllDay: false,
    location: {
    ...
    media: {
      banner: '/images/events/world_meditation_day.jpg',
      thumbnail: '/images/events/world_meditation_day.jpg',
    },
    cta: {
      label: 'Register Now',
  ...
  },
  {
    ...
    /** Nine nights: multi-day ongoing window (start → end inclusive). */
    ...
    media: {
      banner: '/images/events/navratri_celebration.jpg',
      thumbnail: '/images/events/navratri_celebration.jpg',
    },
    cta: {
  ...
  },
  {
    ...
    media: {
      banner: '/images/events/iwc_conference.jpg',
      thumbnail: '/images/events/iwc_conference.jpg',
    },
    cta: {
  ...
  // ==================== ONGOING EVENTS ====================
  // (Channel live stream lives on /events via YouTube block — not a separate “daily webcast” event.)
  ...
  // ==================== PAST EVENTS ====================
  {
    ...
    media: {
      banner: '/images/events/world_culture_festival_2023.jpg',
      thumbnail: '/images/events/world_culture_festival_2023.jpg',
      gallery: [],
      videos: [],
    },
    cta: {
  ...
  },
  {
    ...
    media: {
      banner: '/images/events/world_culture_festival_2016.jpg',
      thumbnail: '/images/events/world_culture_festival_2016.jpg',
    },
    cta: {
      label: 'View Archive',
  ...
  },
  {
    ...
    media: {
      banner: '/images/events/world_culture_festival_2011.jpg',
      thumbnail: '/images/events/world_culture_festival_2011.jpg',
    },
    cta: {
      label: 'View Archive',
  ...
  },
  {
    ...
    media: {
      banner: '/images/events/guinness_yoga_record.jpg',
      thumbnail: '/images/events/guinness_yoga_record.jpg',
    },
    cta: {
      label: 'View Record',
