...
import { getAllEventsSync } from './services/eventService';
import { useEventsClock } from './hooks/useEventsClock';
...
const UpcomingEventsPage = () => {
  ...
  // Get upcoming events (with automatic categorization; refreshes when `endDate` boundaries pass)
  const upcomingEvents = useMemo(() => {
    const merged = getAllEventsSync();
    const filtered = filterEventsByCategory(merged, 'upcoming');
  ...
  useEffect(() => {
    ...
    document.title = 'Upcoming Events | The AOLIC Bangalore';
