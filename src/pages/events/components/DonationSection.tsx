...
export function DonationSection({
  ...
  return (
    <Card className="w-full min-w-0 border-stone-200 shadow-sm dark:border-border/80">
      ...
      <CardContent className="grid w-full min-w-0 gap-6 md:grid-cols-2 md:gap-8 lg:gap-10">
