...
const Settings = () => {
  ...
  const isRootUser = useMemo(() => isAuthenticated && user?.role === 'root', [isAuthenticated, user?.role]);
          ...
          {!isActive ? (
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Root users can enable Canva-like live editing (no code).
                </CardDescription>
              </CardHeader>
              <CardContent>
                {isRootUser ? (
                  ...
                  <div className="text-sm text-muted-foreground">
                    Log in using a Root account to enable editing.
                  </div>
                )}
              </CardContent>
            </Card>
