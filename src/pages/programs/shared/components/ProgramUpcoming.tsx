/**
 * Shared Program Upcoming Programs Component
 *
 * Reusable upcoming programs section with filters.
 */
...
import type { UpcomingProgram, Language } from '../types';

interface ProgramUpcomingProps {
...
export const ProgramUpcoming = ({
  programs,
  onRegister,
  title = 'Upcoming Programs',
  subtitle = 'Find a program that fits your schedule and location',
}: ProgramUpcomingProps) => {
                ...
                <Card className="h-full border border-stone-200 shadow-none hover:shadow-sm bg-white transition-shadow">
                  <CardContent className="p-8">
                    ...
                    <Button
                      ...
                      aria-label={`Register for program on ${program.date}`}
                    >
                      Register
                    </Button>
                  </CardContent>
