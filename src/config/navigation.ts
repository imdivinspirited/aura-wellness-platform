...
export const navigationItems: NavItem[] = [
  ...
  /* ================= INTERNATIONAL ================= */
  {
    ...
    icon: Globe,
    href: '/international',
    description: 'Timezone-aware programs and events for international visitors.',
    priority: 5,
  },
  ...
  /* ================= EXPLORE ================= */
  {
    ...
    icon: Compass,
    href: '/explore',
    description: 'Immerse yourself in the stories, spaces, and wisdom traditions that make The AOLIC Bangalore special.',
    children: [
      {
        id: 'about',
