...
import { authenticate, AuthRequest, requireAuth, requireUser } from '../middleware/auth';
...
cartsRouter.post(
  ...
  [
    ...
    body('itemType').isIn(['program', 'service', 'pass', 'course', 'facility', 'booking', 'application', 'retreat', 'product']),
    body('title').notEmpty(),
